...
const COLORS = ["#020202", "#efa5d4", "#8498e1", "#f7f7f5", "#a4cccb"];
...
export const ProductDetails = () => {
   ...
   /////////////// handle toggle img and color ////////////////
   // const handleToggleImg = () => {
   //    // setToggleImg(prevToggle => (!prevToggle ? true : false));
   //    // setToggleColor(prevToggle => (!prevToggle ? true : false));
   // };
   ...
   // const selectedImage = toggleImg && product?.images[selectedImageIndex];
   // const selectedColorImage =
   //    toggleColor && product?.images[selectedColorIndex];

   // const imageToDisplay = selectedImage || selectedColorImage;
